...
def query_yandex_gpt(iam_token, folder_id, user_text) -> dict:
    ...
    data = {
        "modelUri": f"gpt://{folder_id}/llama-lite",
...
1. Тайм-менеджмент должен быть абстрактным, без привязки к конкретным местам. Используйте теги активности, такие как:
   ...
   Теги: Бары, Наука, Выставки, Архитектура, Музыка, Необычное место, Искусство, Шоппинг, Экстрим, Достопримечательности, Искусство, Музеи, Гулять, Инстаграмные места, Экскурсии, Вкусно поесть
